...
def preprocess_qwen(sources, tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False, max_len=2048, system_message: str = "You are a helpful assistant.") -> Dict:
    ...
    _input_id = []
    num_image = len(re.findall(DEFAULT_IMAGE_TOKEN, system_message))
    texts =system_message.split('<image>')
    ...
    system = [im_start] + _system + _input_id + [im_end] + nl_tokens
    input_id += system
...
if __name__ == "__main__":
    ...
    parser.add_argument("-- ", type=int, default=10000000)
